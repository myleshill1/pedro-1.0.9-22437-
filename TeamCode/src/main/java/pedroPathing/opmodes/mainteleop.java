...
//        pivot.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        double pivotArmoffset = 0.03;
        double openClaw = 0.46;
        double closedClaw = 0.7;
            ...
            switch (state) {
                ...
                case NEUTRAL:
                    ...
                    if (NEUTRAL) {
                        ...
                        LArm.setPosition(0.35+pivotArmoffset);
                        RArm.setPosition(0.35+pivotArmoffset);
                ...
                case MIDDLE:
                    ...
                    if (TIMER.seconds() >= 0.3 && MIDDLE) {
                        ...
                        LArm.setPosition(0.37+pivotArmoffset);
                        RArm.setPosition(0.37+pivotArmoffset);
                ...
                case MIDDLEGRAB:
                    ...
                    if(gamepad2.right_bumper){
                        ...
                        LArm.setPosition(0.27+pivotArmoffset);
                        RArm.setPosition(0.27+pivotArmoffset);
                    ...
                    if(gamepad2.left_bumper){
                        ...
                        LArm.setPosition(0.347+pivotArmoffset);
                        RArm.setPosition(0.347+pivotArmoffset);
                ...
                case SAMPLE:
                    ...
                    if (TIMER.seconds() > 0.65 && Lslides.getCurrentPosition() > 700 && SAMPLED){
                        ...
                        LArm.setPosition(0.4+pivotArmoffset);
                        RArm.setPosition(0.4+pivotArmoffset);
                ...
                case SPECI:
                    ...
                    if (gamepad2.left_bumper) {
                        LArm.setPosition(pivotArmWall+pivotArmoffset);
                        RArm.setPosition(pivotArmWall+pivotArmoffset);
                    ...
                    if (TIMER.seconds() > 0.2 && GRABBDSPECI) {
                        ...
                        LArm.setPosition(pivotArmSpecimenScoring+pivotArmoffset);
                        RArm.setPosition(pivotArmSpecimenScoring+pivotArmoffset);
